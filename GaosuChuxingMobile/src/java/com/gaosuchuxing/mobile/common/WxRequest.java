...
//            wxAuthCodeUrl += "&scope=snsapi_base";
    ...
    public static String getAccessToken() {
        try {
            ...
            String url = WxConfig.ACCESS_TOKEN_URL_CGI + "?grant_type=client_credential";
    ...
    public static String getAccessTokenByCode(String authCode) {
        try {
            HttpClient client = new HttpClient();
...
//            String responseBody = new String(post.getResponseBody(), "UTF-8");
    ...
    public static JSONObject getWxPrepayInfo(HttpServletRequest request, HttpServletResponse response, String wxOpenId, String goodsName, int amount) {
...
//                json.put("package", packageValue);
    ...
    public static JSONObject getSignatureInfo(String url) {
        String ticket = getJsApiTiket();
        
        Map<String, String> sign = WxSign.sign(ticket, url);
...
//        
//        String value = "jsapi_ticket=" + ticket + "&noncestr=" + nonceStr + "&timestamp=" + timestamp + "&url=" + url;
//        
//        String signature = Sha1Util.getSha1(value);
        
        JSONObject json = new JSONObject();
        json.put("appId", WxConfig.APP_ID);
        json.put("nonceStr", sign.get("nonceStr"));
        json.put("url", url);
        json.put("signature", sign.get("signature"));
        json.put("jsapiTicket", ticket);
        json.put("timestamp", sign.get("timestamp"));
