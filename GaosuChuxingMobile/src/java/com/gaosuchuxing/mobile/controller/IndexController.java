...
public class IndexController extends MultiActionController {
    ...
    public ModelAndView advertise(HttpServletRequest request, HttpServletResponse response) {
        ...
        int noticeId = NumberUtil.strToInt(request.getParameter("id"));
        ...
        if (noticeId != -1) {
            session.removeAttribute(Constant.SESSION_INFO.NOTICE_ID);
            session.setAttribute(Constant.SESSION_INFO.NOTICE_ID, noticeId);
        }
        ...
        if (Constant.DEV_MODE) {
            ...
            Object obj = session.getAttribute(Constant.SESSION_INFO.NOTICE_ID);
            if (obj != null) {
                int id = NumberUtil.strToInt(obj.toString());
                mav.addObject("noticeId", id);
            }
    ...
    public String wxpayNotify(HttpServletRequest request, HttpServletResponse response) { 
        try {
            ...
            System.out.println("wxpayNotify: " + msgxml);     
...
//            Order order=orderService.findBySn(sn);  
            ...
            if(result_code.equals("SUCCESS")/*&&member!=null&&order!=null*/) {  
                System.out.println("wxpayNotify: " + "SUCCESS");     
//                //验证签名  
...
//                packageParams.put("sub_mch_id", sub_mch_id);   
                ...
                System.out.println("myinfo: " + packageParams.toString());
                ...
                if(sign.equals(endsign)){//验证签名是否正确  官方签名工具地址：https://pay.weixin.qq.com/wiki/tools/signverify/   
                    System.out.println("wxpayNotify: " + "sign success"); 
//                    if("订单没有支付"){  
//                        try{  
//                        //处理自己的业务逻辑  
