...
public class GetWxOrderno
{
  ...
  public static String getPayNo(String url,String xmlParam){
	//  System.out.println("xml是:"+xmlParam);
	  ...
	  client.getParams().setParameter(ClientPNames.ALLOW_CIRCULAR_REDIRECTS, true);
          ...
          if (Constant.DEV_MODE) {
              HttpHost proxy = new HttpHost("10.70.250.242",8080);
	...
	//     System.out.println("json是:"+jsonStr);
            ...
            System.out.println("getPayNo MSG: " + jsonStr);
//            if (out != null)
//                com.gaosuchuxing.mobile.util.CommonUtil.sendMessageResponse(out, jsonStr);
