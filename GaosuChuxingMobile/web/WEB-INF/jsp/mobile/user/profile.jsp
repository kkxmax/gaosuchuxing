...
<div class="delivery container-fluid container-lf-space main-body init-div-horizontal">
    ...
    <div class="row init-div-horizontal margin-top-20 margin-bottom-20 profile-content" data-toggle="modal" data-target="#contact-modal">
        <div class="col-xs-11 init-div-horizontal">
...
<div class="modal fade bs-modal-lg" id="contact-modal" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;margin-top: 80%;margin-left: 5%;margin-right: 5%">
            ...
            <div class="custom-modal-body" style="">
                <div class="col-xs-12 init-div">
                    ...
                    <div class="col-xs-9 init-div">
                        <p class="custom-phone-number">400-600-8888</p>
                    </div>
                </div>
            </div>
            <div class="custom-modal-footer">
                <div class="col-xs-12 init-div">
                    <div class="col-xs-6 init-div" style="border-right: 1px solid #EFEFEF;height: 48px">
                        <center><label class="modal-button" type="button" style="color:#3D6DBB">立即拨打</label></center>
                    </div>
