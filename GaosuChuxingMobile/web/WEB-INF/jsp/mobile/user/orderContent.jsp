...
<div class="delivery container-fluid container-lf-space main-body init-div-horizontal shop" style="background: #f5f5f5;padding: 0px 10px; margin-bottom: 10px;">
                ...
                <div class="col-xs-12 init-div-horizontal">
                    ...
                    <div class="col-xs-11 init-div-horizontal">
                        <p class="init-div-vertical" style="font-size: 15px;">
                            <b>${order.userName}</b>
                            <b style="color: #3d6cbc;">${order.userTelNo}</b>
                        </p>
                    </div>
                </div>
                <div class="col-xs-12 init-div-horizontal" style="margin-top: 10px">
