...
public class Constants {
    ...
    public static final KeyValueString[] C_SERVICE_BOOKTYPE_NAME = new KeyValueString[] {
    	new KeyValueString(String.valueOf(ServicesDAO.SERVICE_BOOKTYPE_ENTERPRISE), "企业"),
    	new KeyValueString(String.valueOf(ServicesDAO.SERVICE_BOOKTYPE_PERSONAL), "个人")
    };
  ...
  //评价类型
    ...
    //通过类型
	public static final Object C_ERROR_STATUS_NAME = new KeyValueString[] {
    	new KeyValueString(String.valueOf(ErrorsDAO.ERROR_ST_PROCESSING), "审核中"),
    	new KeyValueString(String.valueOf(ErrorsDAO.ERROR_ST_PASS), "审核通过"),
    	new KeyValueString(String.valueOf(ErrorsDAO.ERROR_ST_NOPASS), "审核未通过")
    };
