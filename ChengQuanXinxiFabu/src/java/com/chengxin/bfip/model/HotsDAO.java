    ...
    public List<Hots> search(JSONObject filterParamObject, String extraWhere) {
        ...
        if (queryList != null) {
            ...
            for(int i = 0; i < listSize; i++) {
                ...
                row.setVisit_cnt(CommonUtil.toIntDefault(objectArray[3]));
                row.setComment_cnt(CommonUtil.toIntDefault(objectArray[4]));
                row.setRemark_cnt(CommonUtil.toIntDefault(objectArray[5]));
                row.setShare_cnt(CommonUtil.toIntDefault(objectArray[6]));
                row.setUp_time(DateTimeUtil.stringToDate(CommonUtil.toStringDefault(objectArray[7])));
                row.setDown_time(DateTimeUtil.stringToDate(CommonUtil.toStringDefault(objectArray[8])));
                row.setContent(CommonUtil.toStringDefault(objectArray[9]));
                row.setSt(CommonUtil.toIntDefault(objectArray[10]));
                row.setAccount_id(CommonUtil.toIntDefault(objectArray[11]));
                row.setWrite_time(DateTimeUtil.stringToDate(CommonUtil.toStringDefault(objectArray[12])));
                row.setKind_name(CommonUtil.toStringDefault(objectArray[13]));
                row.setSt_name(CommonUtil.toStringDefault(objectArray[14]));
                row.setXyleixing_level1_id(CommonUtil.toIntDefault(objectArray[15]));
                row.setXyleixing_level1_name(CommonUtil.toStringDefault(objectArray[16]));
