...
var userCouponList = function () {
    ...
    table.dataTable({
        ...
        "ajax": {
            ...
            type: 'POST',
            data: {searchKey: $('#searchKey').val(), keyword: $('#keyword').val(), userCouponStatus: $('#userCouponStatus').val()}
        },
        "lengthMenu": [
            [5, 15, 20, -1],
    ...
    var tableWrapper = jQuery('#usercoupon-list_wrapper');
