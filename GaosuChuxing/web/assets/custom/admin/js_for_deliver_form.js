...
var handleValidateDeliverForm = function() {
    var form1 = $('#deliverForm');
...
//            }
            if ($('#id').val() == '0') {
                $.ajax({
                    url: $('#validate-deliver-id-url').val(),
                    type: 'POST',
                    data: {deliverId: $('#deliverId').val()},
                    success: function(_result) { 
                        if (_result != null && _result == 'success') {                        
//                            form.submit();

                            $.ajax({
                               url: $('#validate-deliver-name-url').val(),
                               data: {deliverId: $('#deliverId').val(), deliverName: $('#name').val()},
