...
function addDetail(_type) {
    if (_type == 'full') {
        ...
        $.ajax({
            ...
            data: {fullAmount: $('#fullFullAmount').val(), couponAmount: $('#fullCouponAmount').val(), qty: $('#fullQty').val(), type: _type, rate: $('#fullRate').val(), tmpUId: $('#tmpUId').val(), name: $('name').val()},
            success: function(_result) {
                if (_result == 'success') {
                    onLoadFullDetails();
                    onLoadUnlimitedDetails();
        ...
        $.ajax({
            cashe: false,
            url: $('#add-tmp-activity-detail-url').val(),
            data: {couponAmount: $('#unlimitedCouponAmount').val(), qty: $('#unlimitedQty').val(), type: _type, rate: $('#unlimitedRate').val(), tmpUId: $('#tmpUId').val(), name: $('name').val()},
            success: function(_result) {
                if (_result == 'success') {
                    onLoadUnlimitedDetails();
                    onLoadFullDetails();
