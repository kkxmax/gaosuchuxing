                ...
                <form:form commandName="shopForm" action="${pageContext.request.contextPath}/admin/shopFormPost/${url}" cssClass="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <c:choose>
                                    <c:when test="${shopForm.type == 'company'}">
                                        <form:textarea path="description" cssClass="form-control validation-control" rows="3" maxlength="40"/>
                                    </c:when>
                                    <c:otherwise>
                                        <form:textarea path="description" cssClass="form-control validation-control" rows="3" maxlength="100"/>
                                    </c:otherwise>
                                </c:choose>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <c:choose>
                                    <c:when test="${not empty shopForm.imagePath}">
                                        <img src="/${shopForm.imagePath}" alt="Icon" class="img-responsive" id="img_preivew" style="width: 100%"/>
                                    </c:when>
                                    <c:otherwise>
