            ...
            <div class="portlet-body form">
                <form:form commandName="orderForm" cssClass="form-horizontal">
                    <div class="form-body">                        
                                        ...
                                        <tbody>
                                            <c:forEach var="orderDetail" items="${orderDetailList}">
                                                <tr>
                                                    ...
                                                    <td><fmt:formatNumber pattern="#0.00" value="${orderDetail.amount}" /></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">预订送达时间：</label>

                            <div class="col-md-4">
                                <label class="form-control"><fmt:formatDate pattern="HH:mm" value="${orderForm.predictDate}" />前</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <label class="form-control">${shop.districtParentName} ${shop.districtName} ${orderForm.stationName}</label>
                            </div>
                        </div>
