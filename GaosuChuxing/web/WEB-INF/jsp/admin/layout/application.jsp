...
<html lang="zh-CN" class="no-js">
    ...
    <head>
        ...
        <link href="<c:url value="/assets/global/plugins/jcrop/css/jquery.Jcrop.min.css"/>" rel="stylesheet"/>
        <link href="<c:url value="/assets/admin/pages/css/image-crop.css"/>" rel="stylesheet"/>
        <!-- BEGIN PAGE LEVEL STYLES -->
        <!-- BEGIN THEME STYLES -->
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content">
        ...
        <input type="hidden" id="get-shop-ord-url" value="<c:url value="/admin/getShopOrd"/>" />
        <input type="hidden" id="update-shop-ord-url" value="<c:url value="/admin/updateShopOrd"/>" />
        <!-- END HIDDEN FEILED -->
        ...
        <script type="text/javascript" src="<c:url value="/assets/global/plugins/jcrop/js/jquery.color.js"/>"></script>
        <script type="text/javascript" src="<c:url value="/assets/global/plugins/jcrop/js/jquery.Jcrop.min.js"/>"></script>
        ...
        <script type="text/javascript" src="<c:url value="/assets/admin/pages/scripts/form-image-crop.js"/>"></script>
