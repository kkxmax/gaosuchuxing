                ...
                <form:form commandName="activityNoticeForm" cssClass="form-horizontal" method="post">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <form:input type="text" path="shareTitle" cssClass="form-control" placeholder="输入分享链接标题" maxlength="255" readonly="true"/>
                            </div>
                        </div>             
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <form:textarea path="shareContent" cssClass="form-control" rows="3" maxlength="255" disabled="true"/>
                            </div>
                        </div>    
                    </div>
