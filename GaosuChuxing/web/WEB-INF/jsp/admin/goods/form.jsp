                ...
                <form:form commandName="goodsForm" action="${pageContext.request.contextPath}/admin/goodsFormPost/${url}" cssClass="form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <form:textarea path="description" cssClass="form-control" rows="3" maxlength="15"/>
                            </div>
                        </div>
                            ...
                            <div class="col-md-5">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 250px; height: 130px;">
                                        <c:if test="${not empty goodsForm.imagePath}">
                                            <img src="/${goodsForm.imagePath}" alt="Icon"/>
                                        </c:if>
                                        <c:if test="${empty goodsForm.imagePath}">
