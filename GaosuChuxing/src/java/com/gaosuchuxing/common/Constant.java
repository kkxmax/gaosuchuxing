...
public class Constant {
    public static String JdbcUrl = "jdbc:mysql://10.70.3.61:3306/gaosuchuxing_db";
    public static String DbUser = "gaosuchuxing";
    public static String DbPwd = "gaosuchuxing@2017";
    ...
    public static final class ATTRIBUTE {
        ...
        public static final String FEED_BACK_STATUS = "FEED_BACK_STATUS";
    }
    ...
    public static final class PERMISSION {
        ...
        public static final String STATION = "服务区管理";
        public static final String SHOP = "门店管理";
        public static final String GOODS = "商品管理";
        public static final String GOODS_KIND = "商品分类";
        public static final String ORDER = "订单管理";
        public static final String DELIVER_STAT = "配送员统计";
        public static final String ACTIVTY_NOTICE = "活动预告";
        public static final String ACTIVITY = "活动管理";
    ...
    public static final String[] COMPANY_SHOP_COLUMNS = new String[] {
        "shops.name", "shop_kinds.name", "stations.name", "districts.name", "shops.start_fee", "shop.shipping_fee", "shops.ord", "shops.reg_date"
    };
    
    public static final String[] SERVICE_SHOP_COLUMNS = new String[] {
        "shops.name", "shop_kinds.name", "stations.name", "districts.name", "shops.ord", "shops.reg_date"
    };
