...
public class Constant {
    ...
    public static final String[] COMPANY_SHOP_COLUMNS = new String[] {
        "shops.name", "shop_kinds.name", "stations.name", "districts.name", "shops.start_fee", "shop.shipping_fee", "shops.reg_date"
    };
    
    public static final String[] SERVICE_SHOP_COLUMNS = new String[] {
        "shops.name", "shop_kinds.name", "stations.name", "districts.name", "shops.reg_date"
    };
