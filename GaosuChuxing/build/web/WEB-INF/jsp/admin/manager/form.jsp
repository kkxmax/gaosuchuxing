    ...
    <div class="col-md-12">
        <div class="portlet box">
            <div class="portlet-body form">
                <form:form commandName="managerForm" action="${pageContext.request.contextPath}/admin/managerForm/${url}" cssClass="form-horizontal" method="post">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <c:if test="${url != '0'}">
                                    <form:input type="text" path="managerId" cssClass="form-control" placeholder="输入账号" readonly="true"/>
                                </c:if>
                                <c:if test="${url == '0'}">
                                    <form:input type="text" path="managerId" cssClass="form-control validation-control" placeholder="输入账号(建议手机号为准)" maxlength="20" />
                                </c:if>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">权限级别<span class="required" aria-required="true"> *</span></label>

                            <div class="col-md-5">
                                <form:select cssClass="form-control validation-control" path="groupId">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-5">                                
                                ...
                                <a href="<c:url value="/admin/managerList"/>" class="btn default"> 取消 <i class="fa fa-repeat"></i></a>
                            </div>
                        </div>
                    </div>
                </form:form>
