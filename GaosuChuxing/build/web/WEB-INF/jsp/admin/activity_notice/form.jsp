                ...
                <form:form commandName="activityNoticeForm" action="${pageContext.request.contextPath}/admin/activityNoticeFormPost/${url}" cssClass="form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <form:input type="text" path="name" cssClass="form-control validation-control" placeholder="输入活动预告标题" maxlength="30" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <form:textarea path="description" cssClass="form-control" rows="3" maxlength="100"/>
                            </div>
                        </div>
